            ...
            <div class="col-sm">
                <div class="card bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>adminconsole/pdf/accept/saveadd">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ref" id="ref" aria-describedby="helpId" placeholder="หมายเลขเอกสารที่อ้างถึง">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="amount" id="amount" aria-describedby="helpId" placeholder="จำนวนคน" required>
